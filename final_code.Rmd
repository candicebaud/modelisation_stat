...
### Résidus modifiés (en essayant d'enlever la trend saisonnière)
Le premier graphe correspond à la série différenciée pour les résidus des hospitalisations, le deuxième à la différence d'ordre 7 de cette même série différenciée. 
```{r, fig.align="center"}
test_res <- diff(res[[1]]$residuals, lag = 1)
test_res_2 <- diff(test_res, lag = 7)
checkresiduals(test_res_2)
checkresiduals(test_res)
```
